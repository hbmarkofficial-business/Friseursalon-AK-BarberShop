  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon AK BarberShop Berlin | Premium Barbershop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Friseursalon AK BarberShop in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Friseursalon AK BarberShop | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Friseursalon AK BarberShop | Premium Barbershop Berlin" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Barbershop",
            "name": "Friseursalon AK BarberShop",
